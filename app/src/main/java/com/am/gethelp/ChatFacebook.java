...
public class ChatFacebook extends BaseActivity {
    ...
    public void iniComponent() {
        ...
        adapter.insertItem(new Message(adapter.getItemCount(), "مرحباً", false, adapter.getItemCount() % 5 == 0, getFormattedTimeEvent(System.currentTimeMillis())));
        adapter.insertItem(new Message(adapter.getItemCount(), "انا سحر العلمي خبيرة الأسرة الصحة الإنجابية، كيف بقدر اساعدك؟", false, adapter.getItemCount() % 5 == 0, getFormattedTimeEvent(System.currentTimeMillis())));
        adapter.insertItem(new Message(adapter.getItemCount(), "مرحبا", true, adapter.getItemCount() % 5 == 0, getFormattedTimeEvent(System.currentTimeMillis())));
        adapter.insertItem(new Message(adapter.getItemCount(), "عندي حاببة اسأل عن عدد معالق السكر اللازمة لعمل كأس قهوة؟", true, adapter.getItemCount() % 5 == 0, getFormattedTimeEvent(System.currentTimeMillis())));
